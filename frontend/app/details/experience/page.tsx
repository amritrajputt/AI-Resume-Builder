...
export default function ExperiencePage() {
  ...
  return (
    <div className="w-full max-w-xl my-20 mr-50">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Work Experience</h2>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 dark:border-neutral-800 bg-white dark:bg-[#141414] text-neutral-900 dark:text-white px-3.5 py-2.5 text-sm outline-none focus:border-blue-500 disabled:bg-gray-100 dark:disabled:bg-neutral-900 disabled:text-gray-500"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 dark:border-neutral-700 text-blue-600 focus:ring-blue-500"
              />
              <label
                htmlFor={`curr-${index}`}
                className="text-xs text-gray-600 dark:text-neutral-400 select-none cursor-pointer"
              >
